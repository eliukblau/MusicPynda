...
# === ELIUK: se modificaron las rutas de busqueda de las librerias ===
if sys.platform.find('win32') != -1:
    bass_module = ctypes.WinDLL('./bin/bass.dll')
    func_type = ctypes.WINFUNCTYPE
elif sys.platform.find('darwin') != -1:
    bass_module = ctypes.CDLL('./bin/libbass.dylib', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
else: # linux, haiku, etc.
    bass_module = ctypes.CDLL('./bin/libbass.so', mode=ctypes.RTLD_GLOBAL)
    func_type = ctypes.CFUNCTYPE
